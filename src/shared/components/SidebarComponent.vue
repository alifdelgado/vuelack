...
<template>
  <aside id="logo-sidebar" class="top-0 left-0 z-40 w-64 h-full" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-slate-800 text-white">
      <ul class="space-y-2 font-medium">
        <li>
          <a href="#" class="flex items-center p-2 group hover:underline">
            <svg
        ...
        <li>
          <button
            type="button"
            class="flex items-center w-full p-2 text-base transition duration-75 group hover:underline"
          ...
          <ul id="dropdown-example" class="hidden py-2 space-y-2">
            <li>
              <a
                href="#"
                class="flex items-center w-full p-2 transition duration-75 pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                >Products</a
              >
            </li>
            <li>
