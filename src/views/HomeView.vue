...
<template>
  <section
    class="bg-cover bg-no-repeat bg-[url('@/assets/background.jpg')] bg-gray-700 bg-blend-multiply"
  >
    <div class="text-center h-screen flex flex-col justify-center items-center">
      ...
      >
        We connect all the people
      </h1>
      <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">
        Forget the security problems, trust with us we solved all your suspects about intruders
        hearing your communications, we love privacy and we respect your rights
      </p>
